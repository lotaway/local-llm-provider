...
class FileProcessor:
    ...
    def save_uploaded_file(
        self, file_obj: BinaryIO, original_filename: str
    ) -> Tuple[str, str, str]:
        """
    ...
    def process_pdf_file(self, file_path: str, file_name: str) -> Dict:
        ...
        try:
            ...
            with open(file_path, "rb") as pdf_file:
                ...
                logger.info(
                    f"Loaded PDF file: {file_name} ({len(pdf_reader.pages)} pages)"
                )
                return {
                    "type": "document",
                    "name": file_name,
    ...
    def inject_file_context_to_messages(
        self, messages: List, file_ids: List[str]
    ) -> List:
        """
